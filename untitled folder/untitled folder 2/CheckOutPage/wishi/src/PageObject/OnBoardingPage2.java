...
public class OnBoardingPage2 extends BasePage
{
	...
	public OnBoardingPage2(WebDriver driver) {
		super(driver);
	...
	{   
		WaitElementDisplay(By.xpath("//nav//div//span[@class='inner-credentials ng-binding']"));
   		click(ProfileButton);	
	}
    public void ClickOnLogOut() 
	{
    	WaitElementDisplay(By.xpath("//div//li//a[text()[contains(.,'Log Out')]]"));
		click(LogOut);	
	}
