...
public class BookMajorSingleTests extends BaseTest
{
	...
	public void VerifyMoodBoard() 
	{
		...
		chat.RefreshPage();
		chat.ClickMyBooking();
		//driver.findElement(By.xpath("//div//button[@title='Collapse Widget']")).click();
	...
	public void CreateMoodBoard3 ()
	{
		LoginPage login = new LoginPage(driver);
		login.ClickLoginButton();
		Assert.assertTrue(login.ElementDisplay("//div[@class='signup-title']"));
		login.doLogin("LEOstylist@Automation.com", "123456");
		BookingPage booking = new BookingPage(driver);
		booking.Sleep(200);
		booking.ClickMyBooking();
