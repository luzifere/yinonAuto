...
public class BestMatchFemaleTest extends BaseTest2
{

	@Test(priority =3,groups={"sanity-group"})
	public void BestMatchFemaleTest()
	{
		PageObejecs.SignUpPage2 signup = new PageObejecs.SignUpPage2(driver);
		...
		PageObejecs.BestMatchPage2 best = new PageObejecs.BestMatchPage2(driver);
	...
	public void BestMatchFemaleTestWithBack() throws IOException
	{
		setup();
		PageObejecs.SignUpPage2 signup = new PageObejecs.SignUpPage2(driver);
		Random num = new Random();
