...
public class BookMajorMonthlyPlanFSTest extends BaseTest
{
	...
	public void SearchStylist() 
	{
		...
		search.Sleep(200);
		search.SelectStylist("//*[@name='YAstylist Booking']");
	}	
	...
	public void VerifyMoodBoard() throws IOException
	{
		...
		chat.ClickcChatTab();
		chat.WaitElementDisplay(By.xpath("//*[@name='stylist booking']"));
